...
<?php $__env->startSection('content'); ?>
    <div class="flex-1 p-8">
        ...
        <p class="text-[#9caaba] mb-8">Selamat datang di panel administrasi Cineplex, <?php echo e(Auth::user()->name); ?>! Gunakan menu di samping untuk mengelola data operasional bioskop Anda.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-[#283039] rounded-xl p-6 shadow-lg flex flex-col items-start">
                ...
                <a href="<?php echo e(route('admin.movies.index')); ?>" class="mt-4 text-[#0c77f2] text-sm font-medium hover:underline">View All Movies</a>
            </div>
            ...
            <div class="bg-[#283039] rounded-xl p-6 shadow-lg flex flex-col items-start">
                ...
                <a href="<?php echo e(route('admin.showtimes.index')); ?>" class="mt-4 text-[#0c77f2] text-sm font-medium hover:underline">Manage Showtimes</a>
            </div>
            ...
            <div class="bg-[#283039] rounded-xl p-6 shadow-lg flex flex-col items-start">
                ...
                <a href="<?php echo e(route('admin.bookings.index')); ?>" class="mt-4 text-[#0c77f2] text-sm font-medium hover:underline">View All Bookings</a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Project_WFD\theaterapp\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>