...
<div class="flex-1 p-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('admin.showtimes.create')); ?>" class="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-[#0c77f2] text-white text-sm font-bold leading-normal tracking-[0.015em]">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Project_WFD\theaterapp\resources\views/admin/schedules/index.blade.php ENDPATH**/ ?>