                    ...
                    <div class="flex h-full min-h-[700px] flex-col justify-between bg-[#111418] p-4">
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 px-3 py-2 <?php if(Request::routeIs('admin.dashboard')): ?> rounded-xl bg-[#283039] <?php endif; ?>">
                                ...
                                <a href="<?php echo e(route('admin.movies.index')); ?>" class="flex items-center gap-3 px-3 py-2 <?php if(Request::routeIs('admin.movies.*')): ?> rounded-xl bg-[#283039] <?php endif; ?>">
                                    <div class="text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                ...
                                <a href="<?php echo e(route('admin.studios.index')); ?>" class="flex items-center gap-3 px-3 py-2 <?php if(Request::routeIs('admin.studios.*')): ?> rounded-xl bg-[#283039] <?php endif; ?>">
                                    <div class="text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                ...
                                <a href="<?php echo e(route('admin.showtimes.index')); ?>" class="flex items-center gap-3 px-3 py-2 <?php if(Request::routeIs('admin.showtimes.*')): ?> rounded-xl bg-[#283039] <?php endif; ?>">
                                    <div class="text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                ...
                                <a href="<?php echo e(route('admin.bookings.index')); ?>" class="flex items-center gap-3 px-3 py-2 <?php if(Request::routeIs('admin.bookings.*')): ?> rounded-xl bg-[#283039] <?php endif; ?>">
                                    <div class="text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                ...
                                <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center gap-3 px-3 py-2 <?php if(Request::routeIs('admin.users.*')): ?> rounded-xl bg-[#283039] <?php endif; ?>">
                                    <div class="text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-3 px-3 py-2 <?php if(Request::routeIs('profile.*')): ?> rounded-xl bg-[#283039] <?php endif; ?>">
                                <div class="text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                            ...
                            <a href="<?php echo e(route('admin.settings')); ?>" class="flex items-center gap-3 px-3 py-2 <?php if(Request::routeIs('admin.settings')): ?> rounded-xl bg-[#283039] <?php endif; ?>">
                                <div class="text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
...
</html><?php /**PATH D:\laragon\www\Project_WFD\theaterapp\resources\views/layouts/admin.blade.php ENDPATH**/ ?>