...
<header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#2c3035] px-10 py-3">
    ...
    <div class="flex items-center gap-4 text-white">
        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-4">
            <div class="size-4">
...
</header><?php /**PATH /var/www/html/resources/views/layouts/partials/main-navigation.blade.php ENDPATH**/ ?>