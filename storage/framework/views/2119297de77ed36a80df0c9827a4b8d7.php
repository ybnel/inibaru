...
<head>
    ...
    <title><?php echo e(config('app.name', 'Cineplex')); ?> - Verify Email</title>
            ...
            <div class="flex flex-1 items-center justify-center text-center">
                <div class="w-full max-w-md px-4">
                    <h2 class="text-white text-3xl font-bold leading-tight mb-4">
                        <?php echo e(__('Thank you for signing up!')); ?>

                    </h2>

                    <p class="mb-4 text-base text-gray-400">
                        <?php echo e(__('Please verify your email address by clicking the link we\'ve sent to your inbox.')); ?>
                    ...
                    <p class="text-gray-500 text-sm underline mb-6">
                        <?php echo e(__("Didn't receive the code? Check your spam folder or resend")); ?>
...
</html><?php /**PATH /var/www/html/resources/views/auth/verify-email.blade.php ENDPATH**/ ?>