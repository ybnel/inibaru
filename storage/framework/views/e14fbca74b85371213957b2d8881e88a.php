...
<?php $__env->startSection('content'); ?>
    <div class="flex flex-wrap justify-between gap-3 p-4">
        ...
        <a href="<?php echo e(route('admin.movies.create')); ?>" class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-8 px-4 bg-[#0c77f2] text-white text-sm font-medium leading-normal">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Project_WFD\theaterapp\resources\views/admin/films/index.blade.php ENDPATH**/ ?>