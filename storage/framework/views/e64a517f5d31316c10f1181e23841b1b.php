...
<head>
    ...
    <title><?php echo e(config('app.name', 'Cineplex')); ?> - Register</title>
...
<?php endif; ?>
                ...
                <div class="flex px-4 py-3 mt-4">
                  ...
                  >
                    <span class="truncate"><?php echo e(__('Register')); ?></span>
                  </button>
                </div>
                ...
                <p class="text-[#9caaba] text-sm font-normal leading-normal pb-3 pt-1 px-4 text-center">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="underline hover:text-white">Sign In</a>
                </p>
            </form>
          </div>
        </div>
