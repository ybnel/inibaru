{{-- resources/views/dashboard/dashboard_movies.blade.php --}}
        ...
        <div class="overflow-x-auto rounded-xl border border-[#3b4754] bg-[#111418]">
            <table class="min-w-full divide-y divide-[#3b4754]">
                ...
                <tbody class="bg-[#111418] divide-y divide-[#3b4754]">
                    {{-- Loop untuk menampilkan data film dari controller --}}
                    @forelse ($films as $film)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-400">{{ $film->genre }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-400">{{ $film->duration_minutes }}m</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-400">{{ \Carbon\Carbon::parse($film->release_date)->format('d M Y') }}</div>
                            </td>
